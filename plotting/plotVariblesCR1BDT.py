...
def main():
    ...
    inputDir = '/publicfs/cms/user/turuobing/tauOfTTTT_NanoAODOfficial/forMVA/2018/v2cut1tau1lCR2TauF_v76WithVLLAllMassOfficial/mc/variableHists_v0BasicBDTtraining1tau1l_VLLm600/'
