...
{   
    ...
    while (m_reader.Next() && entryCount < numEntries)
    {
        ...
        if(tau1e1Sel){
            ...
            //if(!(jetVarMaker.getJet_num()>= 6 && bjetM_num >= 2 && tauVarMaker.getNum()==1 && (eleTopVarMaker.getNum()+muTopTVarMaker.getNum())==1 )){//!1tau1l CR1
            //if(!(jetVarMaker.getJet_num()== 6 && bjetM_num >= 3 && tauVarMaker.getNum()==1 && (eleTopVarMaker.getNum()+muTopTVarMaker.getNum())==1 )){//!1tau1l CR2
