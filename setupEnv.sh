...
export PYTHONPATH=$PYTHONPATH:/afs/ihep.ac.cn/users/t/turuobing/CMSSW_10_6_20/src/FourTop/hua/src_py/
...
export LIBRARY_PATH=$LD_LIBRARY_PATH:/afs/ihep.ac.cn/users/t/turuobing/CMSSW_10_6_20/src/FourTop/myLibrary/ #complile time
