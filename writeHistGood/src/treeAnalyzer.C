...
void treeAnalyzer::Init()
{
    ...
    if(m_channel=="1tau1l"){
        ...
        std::vector<Double_t> bins = {-0.3, -0.17, -0.08, 0.06, 0.20}; //1tau1l Bin B
        ...
        variableList = "/afs/ihep.ac.cn/users/t/turuobing/CMSSW_10_6_20/src/FourTop/hua/tmva/newCode/inputList/inputList_Official_1tau1l_M600_25var.csv"; 
        ...
        weightfile = "/afs/ihep.ac.cn/users/t/turuobing/CMSSW_10_6_20/src/FourTop/hua/tmva/newCode/BDTTrain/v1VLLM500/inputList_Official_1tau1l_M600_25var.csv/dataset/weight/TMVAClassification_BDT.weights.xml";
